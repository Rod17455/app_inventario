...
import '../../controller/productos_rechazados_controller.dart';
import '../../models/products.dart';


class ProductosRechazoListPage extends StatefulWidget {
  ProductosListRechazadosController con = Get.put(ProductosListRechazadosController());

  @override
  State<ProductosRechazoListPage> createState() => _ProductosRechazoListPageState();
}

class _ProductosRechazoListPageState extends State<ProductosRechazoListPage> {
  @override
